...
export function customNodeAssistantPrompt(
  ...
  return [
    ...
    'Do not use imports, require, fetch, window, document, globalThis, self, process, eval, Function, XMLHttpRequest, WebSocket, EventSource, network, filesystem, browser APIs, or dynamic code execution.',
    '',
    ...
    'Top row: node label and Assistant button.',
    ...
    'Next: displays and controls in array order.',
